...
namespace Ia_ComandaRestaurante.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(Ia_ComandaRestauranteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdFuncionario,NomeDoFuncionario,Cargo,SenhaDeAcesso")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdFuncionario,NomeDoFuncionario,Cargo,SenhaDeAcesso")] Funcionario funcionario)
        {
